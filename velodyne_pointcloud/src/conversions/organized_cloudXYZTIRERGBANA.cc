...
namespace velodyne_pointcloud
{
  ...
  OrganizedCloudXYZTIRERGBANA::OrganizedCloudXYZTIRERGBANA(
    ...
    : DataContainerBase(
        ...
        num_lasers, 0, false, scans_per_block, tf_ptr, 13,
  ...
  void OrganizedCloudXYZTIRERGBANA::newLine()
  {
  ...
  void OrganizedCloudXYZTIRERGBANA::setup(const velodyne_msgs::VelodyneScan::ConstPtr& scan_msg){
  ...
  void OrganizedCloudXYZTIRERGBANA::setup(const velodyne_msgs::VelodynePacket & packet_msg, const uint32_t & seq){
  ...
  void OrganizedCloudXYZTIRERGBANA::addPoint(float x, float y, float z,
